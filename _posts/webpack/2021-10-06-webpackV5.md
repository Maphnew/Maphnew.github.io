...
1. `webpack` 4의 사용 가능한 최신 버전으로 업그레이드하세요.
   ...
   - webpack 버전 4 미만을 사용하는 경우 [webpack 4 마이그레이션 가이드](https://webpack.kr/migrate/4/)를 참고하세요.
...
빌드 errors/warnings를 주의 깊게 읽으세요. 해당하는 조언이 없는 경우 issue를 생성해 주시면 해결해 드리겠습니다.
